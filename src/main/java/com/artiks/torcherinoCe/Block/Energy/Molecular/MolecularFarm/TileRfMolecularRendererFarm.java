...
public class TileRfMolecularRendererFarm extends TileEntitySpecialRenderer<TileRfMolecularFarm> {
    ...
    private static final ResourceLocation PlazmaTextureLocation = new ResourceLocation(Tags.MODID, "textures/prac/plazma_farm.png");
    private static final ResourceLocation ParticlesTextureLocation = new ResourceLocation(Tags.MODID, "textures/prac/particles_farm.png");
    public int ticker;
    ...
    @Override
    public void render(TileRfMolecularFarm tile, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
