...
public final class RegistryArray {
    ...
    public static final Item Time_Wand_lvl6 = new TimeWands.TimeWand_lvl_6(modid+"time_wand_lvl6");
    ...
    public static final Block Torch_lvl_1 = new BlockTorcherino(modid+"torch_lvl1");
    public static final Block Torch_lvl_2 = new BlockTorcherino(modid+"torch_lvl2");
    public static final Block Torch_lvl_3 = new BlockTorcherino(modid+"torch_lvl3");
    public static final Block Torch_lvl_4 = new BlockTorcherino(modid+"torch_lvl4");
    public static final Block Torch_lvl_5 = new BlockTorcherino(modid+"torch_lvl5");
    public static final Block Compressed_Torch_lvl1 = new BlockTorcherino(modid+"compressed_torch_lvl1");
    public static final Block Compressed_Torch_lvl2 = new BlockTorcherino(modid+"compressed_torch_lvl2");
    public static final Block Compressed_Torch_lvl3 = new BlockTorcherino(modid+"compressed_torch_lvl3");
    public static final Block Compressed_Torch_lvl4 = new BlockTorcherino(modid+"compressed_torch_lvl4");
    public static final Block Compressed_Torch_lvl5 = new BlockTorcherino(modid+"compressed_torch_lvl5");
    public static final Block D_Compressed_Torch_lvl1 = new BlockTorcherino(modid+"d_compressed_torch_lvl1");
    public static final Block D_Compressed_Torch_lvl2 = new BlockTorcherino(modid+"d_compressed_torch_lvl2");
    public static final Block D_Compressed_Torch_lvl3 = new BlockTorcherino(modid+"d_compressed_torch_lvl3");
    public static final Block D_Compressed_Torch_lvl4 = new BlockTorcherino(modid+"d_compressed_torch_lvl4");
    public static final Block D_Compressed_Torch_lvl5 = new BlockTorcherino(modid+"d_compressed_torch_lvl5");
