...
public class LocalizedStringKey {
     public static final String modid = Tags.MODID + "_";
     //TileTorcherino
     public String StrS = I18n.format(modid+"gui.text.second");
     public String StrH = I18n.format(modid+"gui.text.hours");
     public String StrM = I18n.format(modid+"gui.text.min");
     public String StrStart = I18n.format(modid+"gui.text.start");
     public String StrEnd = I18n.format(modid+"gui.text.end");
     public String StrTimer = I18n.format(modid+"gui.text.timer");
     ...
     public String StrTextRenderWave = I18n.format(modid+"gui.text.render.wave");
     public String StrTextRenderCube = I18n.format(modid+"gui.text.render.cube");
     ...
     public String RenderSettings = I18n.format(modid+"gui.text.render.settings");
     //Time Manipulator tile
     public String StrTextNeedEnergyTimeManipulator = I18n.format(modid+"gui.text.tile_time_manipulator.energy");
     public String StrTextNeedTimeManipulator = I18n.format(modid+"gui.text.tile_time_manipulator.time");
