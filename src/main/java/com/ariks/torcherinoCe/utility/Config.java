...
public class Config {
    ...
    public static int MTR_RecipeIngot,MTR_RecipeNugget,MTR_RecipeStar,MTR_RecipeEnergyStar;
    public static int EMCParticle,EMCIngot,EMCStar;
...
//Time Energy manipulator tile
            RequiredEnergyTimeManipulator = config.getInt("Tile_Energy_Time_Manipulator_Need_rf",Tile,100_000,1,Integer.MAX_VALUE,"Need rf");
            MaxEnergyTimeManipulator = config.getInt("Tile_Energy_Time_Manipulator_MaxStorage",Tile,1_000_000,1,Integer.MAX_VALUE,"Time maximum storage");
//Storage tile
...
//MolecularTransformers
            MTR_RecipeEnergyStar = config.getInt("Tile_Molecular_Recipe_Energy_Star",Molecular,1_000_000, 1, Integer.MAX_VALUE, "Recipe energy_star rf Energy");
            MTR_RecipeStar = config.getInt("Tile_Molecular_Recipe_Star",Molecular,10_000_000, 1, Integer.MAX_VALUE, "Recipe star rf Energy");
            MTR_RecipeIngot = config.getInt("Tile_Molecular_Recipe_Time_Ingot",Molecular,250_000, 1, Integer.MAX_VALUE, "Recipe time_ingot rf Energy");
            MTR_RecipeNugget = config.getInt("Tile_Molecular_Recipe_Time_Nugget",Molecular,100_000,1,Integer.MAX_VALUE, "Recipe time_nugget rf Energy");
        } finally {
